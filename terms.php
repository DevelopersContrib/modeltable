...
<title>Terms of Service</title>
	<meta name="title" content="Terms of Service <?=$domain?> " />
            ...
            <div class="container">
				<div class="row">
                    <div class="col-md-5 col-sm-8 text-center center-col">
                        <p class="title-large text-uppercase letter-spacing-1 black-text font-weight-600">Survey Ventures Terms</p>
                    </div>
                </div>
                <div class="row">
