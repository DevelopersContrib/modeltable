					...
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand navbar-brand-cust" href="#">
								<img class="nav-logo" src="http://d2qcctj8epnr7y.cloudfront.net/images/2013/logo-modeltable-9.png" alt="">
							</a>
						</div>
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a href="/post-bar.php">Post your Bar</a></li>
										<li><a href="/post-restaurant.php">Post your Restaurant</a></li>
										<li><a href="/signup-talent.php">Signup as Talent</a></li>
									</ul>
								</li>
							</ul>
						</div><!-- /.navbar-collapse -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-5" style="height:910px;">
							<div class="phone">
								<div class="preview">
									<img src="http://easycaptures.com/fs/uploaded/1013/5665375456.jpg" alt="Modeltable - Get the app">
								</div>
							</div>
						</div>
						<div class="col-md-7" style="height:910px;">
							<div class="info-right">
								...
								<h1 class="fnt-300 fnt-sans">
									Setting the vibe with our exclusive network. Hang with the IT crowd.
								</h1>
								<a href="#signUpForm" class="btn btn-lg btn-danger">
