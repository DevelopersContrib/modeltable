...
<title>Staffing Survey Ventures</title>
	<meta name="title" content="Contact Survey Ventures <?=$domain?> " />
	<meta name="description" content="Contact Survey Ventures today." />
	<style>
	.form-wrapper {
            ...
            <div class="container">
                <div class="row">
                    <div style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;" class="col-md-8 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms">
                        <!-- page title -->
                        <h1 class="black-text">Join us</h1>
                        <!-- end page title -->
                    </div>
